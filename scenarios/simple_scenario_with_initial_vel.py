...
def main():
    ...
    try:
        ...
        waypoints = world.get_map().generate_waypoints(distance=12)
        road_waypoints = []
        for waypoint in waypoints:
            if(waypoint.road_id <=1 and waypoint.lane_id == 2):
        ...
        for n, t in enumerate(road_waypoints):
            ...
            batch.append(SpawnActor(blueprint, transform).then(ApplyVelocity(FutureActor, carla.Vector3D(20,0,0))).then(SetAutopilot(FutureActor, True)))
