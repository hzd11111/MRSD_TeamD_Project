    ...
    def resetEnv(self):
        ...
        try:
            ...
            for waypoint in waypoints:
                if(waypoint.road_id == 40 and waypoint.lane_id == 5):
            ...
            filtered_waypoints = self.carla_handler.filter_waypoints(self.carla_handler.get_waypoints(1), road_id=40, lane_id=4)
